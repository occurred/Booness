...
<body>
	<div class="body">
		<h1>
			<g:message code="contact.create" default="Create Contact" />
		</h1>
		...
		<g:form action="save" method="post">
			<input type="hidden" name="compte.id"
				value="${contactInstance?.compte?.id}" id="compte.id" />
			<div class="dialog">
				<table>
					<tbody>
						...
						<tr class="prop">
							...
							<td valign="top"
								...
								<g:textField name="name" value="${contactInstance?.name}" /></td>
						</tr>
						...
						<tr class="prop">
							...
							<td valign="top"
								...
								<g:textField name="telephone"
									value="${contactInstance?.telephone}" /></td>
						</tr>
						...
						<tr class="prop">
							...
							<td valign="top"
								...
								<g:textField name="fax" value="${contactInstance?.fax}" /></td>
						</tr>
						...
						<tr class="prop">
							...
							<td valign="top"
								...
								<g:textField name="zip" value="${contactInstance?.zip}" /></td>
						</tr>
...
onComplete:'updateCities(e)')}"
			...
			<div class="buttons">
				<span class="button"><g:submitButton name="create"
						class="save"
						value="${message(code: 'create', 'default': 'Create')}" />
				</span>
			</div>
		</g:form>
	</div>
