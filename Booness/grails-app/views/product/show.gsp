                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name"><g:message code="product.id" default="Id" />:</td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name"><g:message code="product.photo" default="Photo" />:</td>
                                
                                <td valign="top" class="value"><img alt="${fieldValue(bean: productInstance, field: "name")}" width="600px" src="<g:createLink controller='product' action='renderImage' id='${productInstance.id}'/>"/></td>
