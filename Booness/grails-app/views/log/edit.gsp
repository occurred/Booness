...
<jq:resources />
<jqui:resources />
<title><g:message code="log.edit" default="Edit Log" />
</title>
</head>
<body>
	<div class="body">
					...
					<tbody>
						...
						<tr class="prop">
							<td valign="top" class="name"><label for="title"><g:message
										code="log.title" default="Title" />:</label></td>
							<td valign="top"
								class="value ${hasErrors(bean: logInstance, field: 'title', 'errors')}">
								<g:textField name="title" value="${logInstance?.title}" /></td>
						</tr>
